...
<head>
  ...
  <script>window.p5disableFriendlyErrors = true;</script>
...
```javascript
// Before loading p5.js, set the global flag to disable Friendly Error System
window.p5disableFriendlyErrors = true;
// THEN load p5.min.js via the script tag above
