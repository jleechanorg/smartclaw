...
#
# Installs:
#   openclaw:  com.openclaw.gateway, ai.openclaw.startup-check, scheduled jobs, MC (if present)
...
# ~/agent-orchestrator.yaml → ~/.openclaw/agent-orchestrator.yaml (orch-2u9d)
